...
<h1> Quejas </h1>
	...
	<?php 
    if ($conn) {
	$consulta ="SELECT Q.id_queja, Q.nom_comercio, Q.desc_queja, Q.fecha_queja, Q.email_respuesta,
                       M.nom_municipio,
                       D.nom_depto,
					   R.nom_region
                FROM queja Q 
	...
	if ($resultado) {
        ...
        $email_respuesta = $row['email_respuesta'];
        	...
        	<div id="divquejas">
        		<p>
					<strong>Comercio: </strong>
						...
						<b>Email: </b> <?php echo $email_respuesta ?><br>
